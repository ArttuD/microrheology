...
class Dcam:
    def __init__(self, iDevice, color):
        self.__lasterr = DCAMERR.SUCCESS
        self.__iDevice = iDevice
        self.__hdcam = 0
        self.__hdcamwait = 0
        self.__bufframe = DCAMBUF_FRAME(color)
    ...
    def buf_getframe(self, iFrame,color):
        """
        ...
        Returns:
            ...
            False:  error happenss.  lasterr() returns the DCAMERR value
        """
        if not self.is_opened():
            return self.__result(DCAMERR.INVALIDHANDLE)  # instance is not opened yet.
    ...
    def buf_getframedata(self, iFrame, color):
        """
        ...
        """
        ret = self.buf_getframe(iFrame,color)
        if ret is False:
            return False

        return ret[1]

    def buf_getlastframedata(self,color):
        """
        ...
        Returns:
            ...
            False:  error happens.  lasterr() returns the DCAMERR value
        """
        return self.buf_getframedata(-1,color)
